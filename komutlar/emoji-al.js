...
if(!args[0]) return message.channel.send('Bir link ve ad yazmalısın. `?!emojiekle https://cdn.discordapp.com/emojis/803248213444263996.png W4ldo`');
if(!args[0].endsWith('.png')) return message.channel.send('Doğru bir link yazmalısın.');
if(!args[1]) return message.channel.send('Bir emoji adı yazmalısın. `?!emojiekle https://cdn.discordapp.com/emojis/803248213444263996.png W4ldo`');
